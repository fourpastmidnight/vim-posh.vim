...
syntax region poshBracesFold                          start=/{/     end=/}/ skip=/\%(@"\_.\{-}"@\|@'\_.\{-}'@\|'\%(''\|[^']\)*'\|"\%(\`.\|[^"]\)*"\)/ fold keepend transparent containedin=TOP,poshHashObjFold,poshArrayFold,poshBeginFold,poshProcessFold,poshEndFold,poshCleanFold,poshDynamicParamFold,poshSwitchFold,poshTryFold,poshCatchFold,poshFinallyFold,poshDocExampleCode
